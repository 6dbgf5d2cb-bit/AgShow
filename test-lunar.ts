import { solarToLunar, lunarToSolar, formatLunarDate } from './miniprogram/utils/lunar'

function testSolarToLunar(year: number, month: number, day: number, expectedLunarYear: number, expectedLunarMonth: number, expectedLunarDay: number): boolean {
  try {
...
function testLunarToSolar(lunarYear: number, lunarMonth: number, lunarDay: number, expectedYear: number, expectedMonth: number, expectedDay: number): boolean {
  try {
