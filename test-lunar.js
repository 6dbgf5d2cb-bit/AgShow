const lunar = require('./miniprogram/utils/lunar')
...
function testLunarToSolar(lunarYear, lunarMonth, lunarDay, expectedYear, expectedMonth, expectedDay) {
  try {
    const result = lunar.lunarToSolar(lunarYear, lunarMonth, lunarDay)
...
allPassed = testSolarToLunar(2024, 2, 10, 2024, 1, 1) && allPassed

// 2023年春节: 1月22日 -> 癸卯年正月初一
allPassed = testSolarToLunar(2023, 1, 22, 2023, 1, 1) && allPassed

// 2023年1月21日 -> 壬寅年腊月三十
allPassed = testSolarToLunar(2023, 1, 21, 2022, 12, 30) && allPassed

// 2020年春节: 1月25日 -> 庚子年正月初一
allPassed = testSolarToLunar(2020, 1, 25, 2020, 1, 1) && allPassed

// 2019年12月31日 -> 己亥年腊月初六
allPassed = testSolarToLunar(2019, 12, 31, 2019, 12, 6) && allPassed

// 2019年春节: 2月5日 -> 己亥年正月初一
allPassed = testSolarToLunar(2019, 2, 5, 2019, 1, 1) && allPassed

// 2007年12月12日 -> 丁亥年十月二十三
allPassed = testSolarToLunar(2007, 12, 12, 2007, 10, 23) && allPassed

// 1976年12月19日 -> 丙辰年十月二十九
allPassed = testSolarToLunar(1976, 12, 19, 1976, 10, 29) && allPassed
...
// 农历转阳历测试
allPassed = testLunarToSolar(2024, 1, 1, 2024, 2, 10) && allPassed
allPassed = testLunarToSolar(2023, 1, 1, 2023, 1, 22) && allPassed
allPassed = testLunarToSolar(2022, 12, 30, 2023, 1, 21) && allPassed
allPassed = testLunarToSolar(2020, 1, 1, 2020, 1, 25) && allPassed
allPassed = testLunarToSolar(2019, 12, 6, 2019, 12, 31) && allPassed
allPassed = testLunarToSolar(2019, 1, 1, 2019, 2, 5) && allPassed
allPassed = testLunarToSolar(2007, 10, 23, 2007, 12, 12) && allPassed
allPassed = testLunarToSolar(1976, 10, 29, 1976, 12, 19) && allPassed
